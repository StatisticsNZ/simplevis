...
#' @param x_title X scale title string. Defaults to [Y title].
...
#' @param y_title y scale title string. Defaults to "[X title]".
...
#'   summarise(average_wind = round(mean(wind), 2)) 
#'
#' ggplot_hbar_col(plot_data, year, average_wind, status)
#'
ggplot_hbar_col <-
  function(data,
           x_var,
...
#'   summarise(average_wind = round(mean(wind), 2)) 
#'
#' ggplot_hbar_facet(plot_data, year, average_wind, status)
ggplot_hbar_facet <-
  function(data,
           x_var,
           y_var,
