...
#' @title Simple feature leaflet map <Deprecated - use leaf_sf() instead.>.
...
#' @export
#' @examples
#' leaflet_sf(example_point)
#' 
#' leaflet_sf(example_polygon)
#' 
...
#' @title Simple feature leaflet map that is coloured <Deprecated - use leaf_sf_col() instead.>.
...
#' @export
#' @examples
#' leaflet_sf_col(example_point,
#'               col_var = trend_category)
#'
#' leaflet_sf_col(example_polygon,
#'               col_var = density)
#'
#' leaflet_sf_col(example_polygon,
#'               col_var = density,
