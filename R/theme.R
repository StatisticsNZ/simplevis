...
theme_hbar <-
  function(font_family = "Helvetica",
    ...
    list(
      theme(
        text = element_text(family = font_family, colour = "#323232", size = font_size_body, face = "plain"),
        plot.title = element_text(colour = "#000000", size = font_size_title, face = "bold", hjust = 0.5),
        plot.subtitle = element_text(colour = "#000000", hjust = 0.5),
        ...
        panel.background = element_rect(colour = "white", fill = "white"),
        strip.background = element_rect(colour = "white", fill = "white"),
        strip.text = element_text(hjust = 0.425),
