...
```{r, message = FALSE, warning = FALSE, fig.height = 4, fig.width = 6}
sf <- rnaturalearth::ne_states(country = "Australia", returnclass = "sf") %>% filter(.data$name == "Tasmania")
...
You can set the bounds by adding a `leaflet::fitBounds` layer.
...
```{r}
sf <- rnaturalearth::ne_countries(scale = "large", country = "New Zealand", returnclass = "sf")
