...
gg_hbar(plot_data, average_price, cut, alpha = 0.25)
```
...
gg_hbar_col(plot_data, average_price, cut, col_var = clarity, 
...
ggplot(plot_data) + 
  geom_bar(aes(x = average_price, y = fct_rev(cut), fill = clarity), 
           stat = "identity", 
           position = "dodge",
           width = 0.75) +
