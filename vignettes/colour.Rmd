...
* If `col_method` equals `bin`, then alternatively you can use the `col_breaks_n`argument to adjust number of pretty breaks. 
...
### If `col_method` equals `bin`, then alternatively you can use the `col_breaks_n`argument. 

The `col_breaks_n` argument uses the pretty algorithm to aim for roughly the specified number of pretty breaks.
