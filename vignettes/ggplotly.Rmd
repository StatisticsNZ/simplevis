...
The [{plotly}](https://plotly.com/r/) library provides a `ggplotly` function works to convert ggplot objects to interactive html widgets.
...
* `plotly_col_legend` function to manipulate the order of plotly legends.
...
A variable can be added to the `text_var` in the {simplevis} function. This variable is then used in the ggplotly tooltip when `tooltip = text` is added to the `ggplotly` function.
