...
Sometimes a colouring method of "quantile" will provide too many digits in your legend labels. You can modify these by specifying a vector of these bins manually or using the `bin_cuts_to_interval_labels` function.

```{r}
col_labels <- bin_cuts_to_interval_labels(c(0, 0.038, 0.135, 0.380, Inf))
