...
gg_bar(plot_data,
       ...
       y_title = "Body mass g", 
       size_width = 0.5) +
  ggplot2::geom_text(ggplot2::aes(x = species, y = body_mass_g_p05 - 500, label = body_mass_g_p50),
                     col = "white") +
  ggplot2::geom_errorbar(ggplot2::aes(x = species, ymin = body_mass_g_p05, ymax = body_mass_g_p95), 
                         width = 0.2) +
