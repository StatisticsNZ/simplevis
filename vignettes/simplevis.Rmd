...
In addition, there are specific horizontal functions of `hbar*()`, `hboxplot*()` and `hviolin*()`.
...
From `simplevis` version 5.1.0, there will be able to adjust the themes of any simplevis plot by providing a ggplot2 theme to the theme argument.
...
tibble::tribble(
  ...
  "point", "tibble or data.frame", "Any", "Numeric", "Categorical or numeric", "Categorical", "identity (or jitter)",
  "pointrange", "tibble or data.frame", "Any", "Numeric", "Categorical or numeric", "Categorical", "identity (or jitter)",
