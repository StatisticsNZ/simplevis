...
* `*_rev` to reverse the order of categorical x, y or col scales 
...
simplevis allows users to quickly remove na observations from their plots, by changing `x_na`, `y_na`, `col_na` or `facet_na` to `FALSE`.
