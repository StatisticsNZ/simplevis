...
In addition, there are specific horizontal functions of `hbar*()`, `hboxplot*()`, `hpointrange` and `hviolin*()`.
...
simplevis makes it easy to modify scales.
...
`bar*()` and `hbar*()` plots also provide a `"stack"` position option, which users can select instead of the default `"dodge"`.
...
Refer to the `simplevis` [website](https://statisticsnz.github.io/simplevis/articles/leaflet.html) for further information.
...
tibble::tribble(
  ...
  "boxplot", "tibble or data.frame", "Categorical", "Numeric", "Categorical", "Categorical", "boxplot (or identity)",
  ...
  "pointrange", "tibble or data.frame", "Any", "Numeric", "Categorical or numeric", "Categorical", "identity",
  "sf", "sf", NA, NA, "Categorical or numeric", "Categorical", "identity",
  "smooth", "tibble or data.frame", "Numeric", "Numeric", "Categorical or numeric", "Categorical", "identity",
  ...
  "violin", "tibble or data.frame", "Categorical", "Numeric", "Categorical", "Categorical", "ydensity",
  "hbar", "tibble or data.frame", "Numeric", "Any*", "Categorical or numeric", "Categorical", "identity",
  "hboxplot", "tibble or data.frame", "Numeric", "Categorical", "Categorical", "Categorical", "boxplot (or identity)",
  "hviolin", "tibble or data.frame", "Numeric", "Categorical", "Categorical", "Categorical", "ydensity",
  "hpointrange", "tibble or data.frame", "Numeric", "Any", "Categorical or numeric", "Categorical", "identity",
...
### Output objects and adding ggplot2 layers
...
### Working with the `patchwork` package
...
For further information, see the articles on the [website](https://statisticsexample_borders.github.io/simplevis/).