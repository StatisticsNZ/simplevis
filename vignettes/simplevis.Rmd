...
[{ggblanket}](https://github.com/davidhodge931/ggblanket) is a package I made after {simplevis}. I released version 1.0.0 of {ggblanket} on CRAN in May 2022. 
...
If you need `plotly::ggplotly`, then use `simplevis` until the afore-mentioned bug is fixed. For `leaflet` wrappers, obviously use `simplevis`. 
