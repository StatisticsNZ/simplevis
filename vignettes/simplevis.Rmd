...
plot_data <- penguins %>% 
  ...
  mutate(label = glue::glue("{prettyNum(bill_length_mm, big.mark = ',')} mm"))
...
Note `tile` functions are avaialble from version 4.5.0 and `density` functions from version 4.4.0 of `simplevis`.
