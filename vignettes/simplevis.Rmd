...
* designing families of functions that describe the graph type and aesthetics
* using consistent prefixes designed to work with the Rstudio auto-complete function
* using a straightforward method for colouring that is consistent across functions
