...
They work in essentially the same way as the `ggplot` non-facetted `sf` functions. Arguments have been aligned with simplevis ggplot wrapping functions (e.g. point_size = radius, line_size = weight, alpha = fillOpacity).
