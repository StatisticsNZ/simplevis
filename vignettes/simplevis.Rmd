...
plot_data <- penguins %>%
  group_by(species) %>%
  summarise(body_mass_g_med = median(body_mass_g, na.rm = TRUE),
...
gg_bar_col(plot_data,
           x_var = species,
           y_var = body_mass_g_med,
           col_var = species,
           col_legend_none = TRUE,
           col_na_rm = TRUE,
           y_title = "Body mass g") +
  ggplot2::geom_text(ggplot2::aes(x = species, y = body_mass_g_p05 - 500, label = body_mass_g_med),
                     col = "white") +
