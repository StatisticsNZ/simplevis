...
Outputs are hidden to keep the size of the vignette manageable. Remember to load `sf` or `stars` libraries prior to running `simplevis` `sf` or `stars` functions.
...
```{r, hide = TRUE, echo = TRUE, results = 'hide', fig.height = 4, fig.width = 7}
