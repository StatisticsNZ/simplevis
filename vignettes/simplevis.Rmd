...
* scatter plot (e.g. `ggplot_scatter`)
...
ggplot_sf_col(map_data, trend_category, 
              boundary = nz, 
              size = 0.25, 
              pal = pal, 
...
ggplot_sf_facet(map_data, trend_category, 
                boundary = nz, 
                size = 0.25,
                title = "Monitored river nitrate-nitrogen trends, 2008\u201317")
```
...
ggplot_sf_col_facet(map_data, trend_category, indicator,
                    boundary = nz, 
                    size = 0.25, 
                    pal = pal,
                    title = "Monitored river nitrate-nitrogen trends, 2008\u201317")
...
```{r, message = FALSE, warning = FALSE, fig.height = 4, fig.width = 7}
ggplot_stars_col(example_stars_nz_no3n, 
                 boundary = nz,
...
leaflet_sf_col(map_data, dairydens, 
               col_method = "bin", 
